...
class JWTEditorTest < Test::Unit::TestCase
  ...
  def test_remove_jws
    ...
    2.times do
      ...
      assert_equal %({"payload":"eyJpc3MiOiJteWNvbXBhbnkuZXhhbXBsZSIsImRhdGEiOlsxLDIsM119","signatures":[]}), JSON.generate(new_jwt)
    end
  end
  ...
  def test_remove_jws_when_no_jws_exist
    ...
    assert_equal %({"payload":"eyJxdXgiOiJxdXgifQ","signatures":[]}), JSON.generate(new_jwt)
  end
end
